"""Asserts files are present after build via autohooks hook."""
...
def __get_assert_files_config(config: Config) -> Config:
...
def _get_files_to_assert_files(
    ...
    assert_files_config = __get_assert_files_config(config)
